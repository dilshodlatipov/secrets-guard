...
public class SecretsGuardProperties {
    ...
    public static class Ai {
        ...
        public List<String> getSkipRegexIds() { return skipRegexIds; }
    }

    public static class Scan {
        private long maxFileSizeBytes = 1_048_576;
        private final List<String> ignore = new ArrayList<>(List.of(".git", "target", "build", "node_modules"));
    ...
    public static class Hooks {
        ...
        public String getPreCommitCommand() { return preCommitCommand; }
        public void setPreCommitCommand(String preCommitCommand) { this.preCommitCommand = preCommitCommand; }
    }
}
