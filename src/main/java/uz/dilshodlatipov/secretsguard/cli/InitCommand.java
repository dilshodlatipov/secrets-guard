...
@Command(command = "init", description = "Initialize secrets-guard git hook and perform a full scan")
public class InitCommand {
    ...
    @Command(command = "init", description = "Install the pre-commit hook and scan the repo")
    public String init(@Option(longNames = "path", defaultValue = ".") Path path,
                       @Option(longNames = "skip-scan", defaultValue = "false") boolean skipScan) {
